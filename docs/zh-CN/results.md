...
10 项 frozen-core test、1 条公共 CDC bridge command 和 2 条 width-specific
command。每条 integration command 会额外输出 quiesce marker，因此每个异步
profile 从 13 条 command 要求 14 个 marker。
