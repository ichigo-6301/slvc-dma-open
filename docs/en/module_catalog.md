...
| Memory and CQ | `dma_axi_write_engine`, `dma_axi_read_prefetch`, `dma_cq_writer`, `dma_cq_single_writer` | RX write, TX read/prefetch, and owner-last completion publication. |
...
The catalog describes the released 512-bit source set. It is not a promise that
