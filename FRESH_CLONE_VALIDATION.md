...
8. With Vivado 2018.3 available, run one bounded `Explore` OOC implementation using `fpga-ooc`.
9. Confirm `git status --short` is empty after ignored build and simulator outputs are produced.
