...
| Memory and CQ | `dma_axi_write_engine`, `dma_axi_write_engine_512`, `dma_axi_read_prefetch`, `dma_cq_writer`, `dma_cq_single_writer` | 默认 RX write、可选同频 wide RX write、TX read/prefetch 和 owner-last completion publication。 |
